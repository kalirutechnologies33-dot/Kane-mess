          ...
          <div className="floating-card bg-white rounded-3xl p-8 sm:p-10 border border-emerald-100/90 relative group flex flex-col justify-between overflow-hidden">
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-4 mb-6">
                ...
                <span className="px-3.5 py-1.5 rounded-full text-xs font-bold bg-emerald-100 text-forest-900 border border-emerald-300/60 shadow-sm font-display">
                  Hygiene Certified A+
                </span>
              </div>
              ...
              {/* Title & Subtitle */}
              <div className="mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600 font-display">Farm-Fresh & Pure</span>
                <h3 className="text-2xl sm:text-3xl font-display font-bold text-forest-900 mt-1">
                  Premium Quality
                </h3>
              </div>
              ...
              <div className="space-y-3 pt-2 mb-8">
                {[
                  "100% natural spices & stone-ground masala blends",
                  "Sanitized commercial kitchen with daily safety audits",
                  "Traditional slow-cooking with wood-fire and pure ghee aroma"
                ].map((item, idx) => (
          ...
          <div className="floating-card bg-white rounded-3xl p-8 sm:p-10 border border-emerald-100/90 relative group flex flex-col justify-between overflow-hidden">
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-4 mb-6">
                ...
                <span className="px-3.5 py-1.5 rounded-full text-xs font-bold bg-forest-100 text-forest-900 border border-forest-300/60 shadow-sm font-display">
              ...
              {/* Title & Subtitle */}
              <div className="mb-4">
                <span className="text-xs font-bold uppercase tracking-widest text-emerald-600 font-display">Precision Hot Delivery</span>
                <h3 className="text-2xl sm:text-3xl font-display font-bold text-forest-900 mt-1">
                  Timely Service
                </h3>
              </div>
